...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Animal.created'
        db.add_column(u'birds_animal', 'created',
        ...
        db.alter_column(u'birds_event', 'status_id', self.gf('django.db.models.fields.related.ForeignKey')(default=8, to=orm['birds.Status']))

        # Changing field 'Event.date'
        db.alter_column(u'birds_event', 'date', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):
        # Deleting field 'Animal.created'
        db.delete_column(u'birds_animal', 'created')


        # Changing field 'Event.status'
        db.alter_column(u'birds_event', 'status_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['birds.Status'], null=True))

        # Changing field 'Event.date'
        db.alter_column(u'birds_event', 'date', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        u'birds.event': {
            ...
            'status': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['birds.Status']"})
        },
        u'birds.location': {
