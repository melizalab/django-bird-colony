...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Age'
        db.create_table(u'birds_age', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=16)),
            ('min_days', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('max_days', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('species', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['birds.Species'])),
        ))
        db.send_create_signal(u'birds', ['Age'])


    def backwards(self, orm):
        # Deleting model 'Age'
        db.delete_table(u'birds_age')
