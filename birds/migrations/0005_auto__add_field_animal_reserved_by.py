...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Status.category'
        db.add_column(u'birds_status', 'category',
                      self.gf('django.db.models.fields.CharField')(max_length=2, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Animal.reserved_by'
        db.add_column(u'birds_animal', 'reserved_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Status.category'
        db.delete_column(u'birds_status', 'category')

        # Deleting field 'Animal.reserved_by'
        db.delete_column(u'birds_animal', 'reserved_by_id')
    ...
    models = {
        ...
        u'birds.age': {
            ...
            'min_days': ('django.db.models.fields.PositiveIntegerField', [], {}),
        ...
        u'birds.animal': {
            ...
            'reserved_by': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']", 'null': 'True', 'blank': 'True'}),
