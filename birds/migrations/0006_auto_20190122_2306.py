# Generated by Django 2.1.5 on 2019-01-23 04:06
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='sample',
            name='animal',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='birds.Animal'),
        ),
        migrations.AddField(
            model_name='sample',
            name='collected_by',
        ...
        migrations.AddField(
            model_name='sample',
            name='location',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='birds.SampleLocation'),
        ),
        migrations.AddField(
            model_name='sample',
            name='source',
