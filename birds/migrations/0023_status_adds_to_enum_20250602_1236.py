# Generated by Django 5.1.4 on 2025-06-02 16:36
...
def convert_boolean_to_enum(apps, schema_editor):
    ...
    # Set all addition types to internal for now
    for status in Status.objects.all():
        if status.adds:
            status.adds_new = 'internal'
        else:
        ...
        migrations.AddField(
            ...
            field=models.CharField(
                ...
                choices=[
                    ...
                    ('internal', 'Added from within the colony'),
                    ('external', 'Added from outside the colony')
                ],
                null=True,
                blank=True,
                default=None,
